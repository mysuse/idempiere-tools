...
update c_cash set processed='N',docstatus='DR',posted='N',docaction='CO';
update c_cashline set processed='N';

update c_payment set docstatus='DR',reversal_id=null,isallocated='N',isreconciled='N',docaction='CO',posted='N',isapproved='N',processed='N',processedon=0;
update c_invoice set docstatus='DR',reversal_id=null,docaction='CO',posted='N',isapproved='N',processed='N',processedon=0,ispaid='N';
update c_invoiceline set processed='N';

update gl_journal set reversal_id=null;

update gl_journal set docstatus='DR',docaction='CO',posted='N',isapproved='N',processed='N',processedon=0;
update gl_journalline set processed='N';

update m_inventory  set docstatus='DR',processed='N';
update m_inout set docstatus='DR',docaction='CO',posted='N',isapproved='N',processed='N',processedon=0;

update m_production set docstatus='DR',reversal_id=null,docaction='CO',posted='N',processed='N',processedon=0;
...
--delete from m_productionlinema where m_productionline_id NOT IN (SELECT m_productionline_id FROM m_productionline JOIN m_production ON m_production.m_production_id=m_productionline.m_production_id WHERE m_production.movementdate <='2018-03-31 23:59:59');
--delete from m_productionline where m_production_id NOT IN (SELECT m_production_id FROM m_production WHERE movementdate<='2018-03-31 23:59:59');
--delete from m_production where movementdate <='2018-03-31 23:59:59';
