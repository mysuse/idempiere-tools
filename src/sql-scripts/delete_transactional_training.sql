...
delete from c_orderline WHERE c_order_id IN (SELECT c_order_id FROM c_order WHERE docstatus NOT IN ('DR'));
delete from c_ordertax  WHERE c_order_id IN (SELECT c_order_id FROM c_order WHERE docstatus NOT IN ('DR'));
update r_request set c_order_id = null, M_inout_id = null ;
update r_requestaction set c_order_id = null, M_inout_id = null ;
delete from c_order  WHERE docstatus NOT IN ('DR'));
